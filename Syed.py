...
jalan("\033[1;93m   ▒▒▒▒▒▒▒▒▒▒▒▒ Welcome to SyedZada ▒▒▒▒▒▒▒▒▒▒   ")
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:syed_zada
	    time.sleep(2)
            loop = 'false'
        else:
